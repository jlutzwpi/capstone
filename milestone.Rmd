...
blog.vec <- readLines(file("./en_US/en_US.blogs.txt", "rb"),
                      encoding="UTF-8", skipNul = TRUE)
news.vec <- readLines(file("./en_US/en_US.news.txt", "rb"), encoding="UTF-8", skipNul = TRUE)
...
freq <- subset(freq, freq>= 20)
qplot(names(freq), freq, main="Word Frequencies", geom="bar", xlab="Words")
```
